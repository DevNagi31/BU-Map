...
const META = {
  ...
  AC:  { type:'academic',         h:16, label:'Anderson Ctr',  desc:'Major performing arts venue: Watters Theater, Osterhout Concert Theater, and Chamber Hall.' },
  ...
  ES:  { type:'academic',         h:20, label:'Eng & Sci',     desc:'Engineering and Science Building with advanced research labs and classrooms.' },
  ...
  LH:  { type:'academic',         h:14, label:'Lecture Hall',  desc:'Main lecture building. Multiple tiered auditoriums seat hundreds for large introductory courses.' },
  ...
  // ── Libraries ─────────────────────────────────────
  LN:  { type:'library',          h:36, label:'Lib Tower',     desc:'Iconic Bartle Library tower visible from across campus. Houses upper reading rooms and research collections.' },
  LS:  { type:'library',          h:26, label:'Bartle Lib',    desc:'Glenn G. Bartle Library — main library. Over 2 million volumes, Special Collections, and study areas.' },
  LT:  { type:'library',          h:36, label:'Lib Tower (LT)',desc:'Library Tower (LT) — part of the Bartle Library complex.' },
  // ── Student Services ──────────────────────────────
  ...
  // ── Athletics ─────────────────────────────────────
  EC:  { type:'athletics',        h:24, label:'Events Ctr',    desc:'6,000-seat Events Center — home of Binghamton Bearcats basketball, concerts, and commencement.' },
